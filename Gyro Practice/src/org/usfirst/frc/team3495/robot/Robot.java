...
public class Robot extends IterativeRobot {
	...
	TalonSRX t1 = new TalonSRX(0);
	TalonSRX t2 = new TalonSRX(1);
	TalonSRX t3 = new TalonSRX(2);
	TalonSRX t4 = new TalonSRX(3);
	...
	public void tankDrive(double left, double right) {
		...
		t2.set(ControlMode.Follower, 1);
		t3.set(ControlMode.PercentOutput, -right);
		t4.set(ControlMode.Follower, 3);
	}
