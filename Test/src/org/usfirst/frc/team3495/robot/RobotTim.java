 ...
 * creating this project, you muwst also update the manifest file in the resource
 * directory.
 */
public class RobotTim extends IterativeRobot {
	...
	public void robotInit() {
		...
		enc1.setDistancePerPulse(.02117);
